...
void RealsensePropGetListener::getValue(imaqkit::IPropInfo* propertyInfo, void* value)
{
	...
	if (strcmp(propname, "SR300FocalLengthX") == 0 || strcmp(propname, "SR300FocalLengthY") == 0 || strcmp(propname, "SR300PrincipalPointX") == 0 || strcmp(propname, "SR300PrincipalPointY") == 0 || strcmp(propname, "SR300BaseLine") == 0)
	{
		psm->EnableStream(PXCCapture::STREAM_TYPE_COLOR, RealSense::RS_FCOLOR_DEFAULT_WIDTH, RealSense::RS_FCOLOR_DEFAULT_HEIGHT);
	...
	if (strcmp(propname, "SR300FocalLengthX") == 0 || strcmp(propname, "SR300FocalLengthX") == 0)
	{	
		*(reinterpret_cast<double*>(value)) = (double)calibData.focalLength.x;
	}
	
	else if (strcmp(propname, "SR300FocalLengthY") == 0 || strcmp(propname, "SR300FocalLengthY") == 0)
	{
		*(reinterpret_cast<double*>(value)) = (double)calibData.focalLength.y;
	}
	
	else if (strcmp(propname, "SR300PrincipalPointX") == 0 || strcmp(propname, "SR300PrincipalPointX") == 0)
	{
		*(reinterpret_cast<double*>(value)) = (double)calibData.principalPoint.x;
	}
	else if (strcmp(propname, "SR300PrincipalPointY") == 0 || strcmp(propname, "SR300PrincipalPointY") == 0)
	{
		*(reinterpret_cast<double*>(value)) = (double)calibData.principalPoint.y;
	}

	else if (strcmp(propname, "SR300BaseLine") == 0)
	{
		*(reinterpret_cast<double*>(value)) = RealSense::SR300_BASELINE_IN_MM;;
	}
	else
	{
